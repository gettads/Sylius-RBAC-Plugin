# docker build --pull --tag docker-registry.praguebest.cz:5000/sylius-praguebest-synchronization-bundle.8.1:latest . && docker push docker-registry.praguebest.cz:5000/sylius-praguebest-synchronization-bundle.8.1:latest
